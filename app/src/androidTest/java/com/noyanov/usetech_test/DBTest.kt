...
class DBTest {
    ...
    fun writeBookAndReadById() {
        ...
        GlobalScope.async {
            ...
            val book = BookInfoRoom(test_bookid, test_json)
            dao.insert(book)
            val books = dao.getAlphabetizedBooks()
            //assertThat(books.get(0), equalTo(book))
        }
    }
